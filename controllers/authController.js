...
const createSendToken = (user, statusCode, res) => {
  ...
  const cookieOptions = {
    ...
    // sameSite: 'lax', // IMPORTANT: prevents cookie rejection
    // path: '/',
  };
...
exports.protect = catchAsync(async (req, res, next) => {
  ...
  if (!currentUser) {
    return next(new AppError('The user belongs to this token no longer exits'));
  }
...
// DELETE TOUR RESTRICTION TO ADMIN
