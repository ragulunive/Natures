...
const tourSchema = new mongoose.Schema(
  {
    name: {
      ...
      unique: true,
      trim: true,
      maxlength: [40, 'A tour name must have less or equal than 40 cahracters'],
      minlength: [10, 'A tour name must have less or equal than 10 cahracters'],
      // validate: [validator.isAlpha, 'Tour name must contain only characters'],c
    },
    slug: String,
    duration: {
      type: Number,
